...
return [
    ...
    'pool'       => [
        ...
        'redis' => [
            ...
            'max_active'    => 3,
            'max_wait_time' => 5,
            'password' => 'cache@999house[888]@999house',
            'port'      => 59091,
            /*'host'          => '47.107.72.79',
            'port'          => 59091,
            'password' => '999houseredis!@#'*/
            //'password' => 'm-y-redis-cache@999house[888]@999house'
        ],
    ],
    'coroutine'  => [
        'enable' => true,
    ...
    'tables'     => [
        'uid2fd' => [
            'size' => 10240,
            'columns' => [
                ['name' => 'fd', 'type' => 1, 'size' => 8],//int
                ['name' => 'room_baseinfo', 'type' => 7, 'size' => 256],//string
                ['name' => 'in_background', 'type' => 1, 'size' => 1],
                ['name' => 'online_time', 'type'=> 7, 'size' =>11],
                ['name' => 'login_token', 'type' => 7, 'size' => 64],//string
                ['name' => 'local_ip', 'type'=> 7, 'size' =>19],
                ['name' => 'local_port', 'type'=> 7, 'size' =>6],
            ]
        ],
        'fd2uid' => [
            'size' => 10240,
