...
class IndexController extends UserBaseController
{
    ...
    {
        $indexIndex = new \app\index\controller\IndexController($this->app);
        $indexIndex->index();
        return;
