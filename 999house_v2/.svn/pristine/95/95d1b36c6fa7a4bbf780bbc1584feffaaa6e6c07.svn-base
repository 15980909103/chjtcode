<template>
  <div class="_container">
    <el-form :inline="true" :model="searchData" class="form-serch">
        ...
        <el-form-item label="购买者昵称">
          <el-input style="width:100%" v-model="searchData.user_nickname" placeholder="请输入购买者昵称" prefix-icon="el-icon-search"></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否开户">
          <el-select v-model="searchData.isfirst" placeholder="请选择">
            <el-option label="全部" value="all"></el-option>
        ...
        <el-form-item label="类型">
          <el-select v-model="searchData.dotype" placeholder="请选择">
            <el-option label="全部" value="all"></el-option>
            <el-option label="管理" value="1"></el-option>
            <el-option label="记账" value="2"></el-option>
          </el-select>
        </el-form-item>  
