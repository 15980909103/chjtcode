<template>
	<transition name="van-slide-down">
		<view v-show="showState" class="surface-wrap" :class="showClass">
			...
			<div  class="surface-phone" v-if="list && list.phone" @click.stop="callByPhone"><view class="iconfont icondianhua"></view></div>
