		...
		<view class="active_conten">
			<view class="user_box">
				...
				<view class="consumed">
					...
					<view>剩余名额：{{ (userinfo.coupon_number/(userinfo.sum||1)||0)*100}}%</view>
				</view>
			</view>
			<view class="search">
			...
			<view class="verification_list">
					...
					<view>
						<view class="coupon">
							<view class="coupon_item">
								...
								<view class="coupon_shop" style="padding: 0 20px 0 10px;">
				...
				<u-empty style="min-height: 80vh;" v-if="WorkWriteOfflist.length<=0" text="暂无数据" mode="list"></u-empty>
			</view>
							...
							<view>
								...
								<view class="coupon">
									<view class="coupon_item" style="padding: 20rpx 0;">
										...
										<view class="coupon_shop" style="width: 250rpx; padding: 0 20rpx;">
