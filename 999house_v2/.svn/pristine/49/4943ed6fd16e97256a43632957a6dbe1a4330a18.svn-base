  ...
  <div class="_container">
    <div class="tb-top">
      <el-form :inline="true" :model="searchData" class="form-serch" >
        <el-form-item >
          <el-input v-model="searchData.room_name" placeholder="请输入直播间名称" prefix-icon="el-icon-search"></el-input>
        </el-form-item>
   ...
   <el-dialog
    ...
    >
      <el-form style="padding-right:50px;" :model="formData" ref="formData" :rules="rules">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="折扣信息" prop="desc" :label-width="formLabelWidth">
              <el-input style="width:100%"  v-model="formData.discount" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发放数量" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.total_num" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        ...
        <!-- <el-row>
          <el-col :span="12">
            <el-form-item label="已领取数量" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.receive_num" placeholder="请输入内容,-1为不限制"></el-input>
            </el-form-item>
          </el-col>
        </el-row> -->
...
export default {
  ...
  del(id,val){   //确定删除
    ...
    doSubmit(formName){
      var that = this
      //that.formData.region_no = that.region_no
