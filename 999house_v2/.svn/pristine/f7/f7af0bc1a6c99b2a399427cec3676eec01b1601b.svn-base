    ...
    >
      <el-form style="padding-right:50px;" :model="formData" ref="formData" :rules="rules">
        ...
        <el-form-item  label="底色选择" :label-width="formLabelWidth" ref="bgcolor" prop="bgcolor">
          <el-color-picker el-color-picker v-model="formData.bgcolor" :show-alpha="true"  :color-format="rgba"></el-color-picker>
        </el-form-item>
        <el-form-item  label="文字背景色" :label-width="formLabelWidth" ref="bgcolor" prop="bgcolor">
          <el-color-picker el-color-picker v-model="formData.fontbgcolor" :show-alpha="true" :color-format="rgba"></el-color-picker>
        </el-form-item>
