...
//       var_dump($where);
       ...
       if(is_array($flage)){
        ...
        $list = $group_list;
        $list['share_title'] = '九房网新房找房买房';
        $list['share_context'] = '海量房源，省心省时间';
        $list['share_ico'] = 'https://mo.999house.com//upload/images/admin/admin/t99735676ac125145d8e15cd4875d158a.png';
       }
        if(empty($list)){
             $this->success([]);
        }
