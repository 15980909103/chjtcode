    ...
    <div class="admin_huang admin_heard">
      ...
      <div class="admin_huang" style="width: 33%  ; margin-left: 15px; height: 397px;display: inline-block;position: relative" v-if="institute['xf']">
        ...
        <el-row style="display: flex;flex-direction: row">
          <el-col  style="text-align: center" class="admin_font4" :span="12">
...
<!--                <span style="margin-top: 5px;">{{institute['esf'].price}}</span>-->
                <span style="margin-top: 5px;">{{institute['esf'].price}}</span>
                <span class="admin_font6 el-icon-top" style="margin-top: 5px;" v-if="institute['esf'].last_month_type == 1" >{{institute['esf'].last_month_rate}}</span>
                <span class="admin_font7 el-icon-bottom" style="margin-top: 5px;" v-else>{{institute['esf'].last_month_rate}}</span>
                  ...
                  <template slot-scope="scope">
                    <div style="display: flex;flex-direction: column;height: 53px;" @click="opindexPage(scope.row.id)">
                      <div style="display: flex;flex-direction: row;">
                        <span style="width: 90%;display: inline-block;margin-bottom: 5px;padding-right: 24px" class="amdin_outtitle admin_font9">{{scope.row.name}}</span>
