  ...
  <div class="_container">
    <div class="tb-top" style="float:right;margin-bottom: 30px;">
      <el-form :inline="true" :model="searchData" class="form-serch" >
        ...
        <mycity-select :city_no.sync='searchData.city_no' :unlimitedCity='true' :isMy='true' model='3' siteAreasUrl='city/siteAreas'></mycity-select>
    ...
    <el-table class="tb-title" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="cname" label="商圈" width="180" align="center"></el-table-column>
   ...
   <el-dialog
    ...
    >
      <el-form style="padding-right:50px;" :model="formData" ref="formData" >
        <el-form-item class="city-box" label="商圈名称"  :label-width="formLabelWidth"  >
    ...
    doSubmit(formName){
      ...
      that.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          util.requests("post",{
            url:"city/siteBusinessAreasEdit",
            data:that.formData
          }).then(res=>{
