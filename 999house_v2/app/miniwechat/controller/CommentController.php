...
class CommentController extends UserBaseController
{
    ...
    {
        $indexComment  = new \app\index\controller\CommentController($this->app);
        $indexComment->propertyReviewsList();
        return;
    ...
    {
        $indexComment  = new \app\index\controller\CommentController($this->app);
        $indexComment->propertyReviewsComment();
        return;
        $user_id = $this->userId;
    ...
    public function propertyReviewsLike(){
        $indexComment  = new \app\index\controller\CommentController($this->app);
        $indexComment->propertyReviewsLike();
        return;
        $param['id'] = $this->request->param('id');
    ...
    public function base64ImgSave($image){
        $indexComment  = new \app\index\controller\CommentController($this->app);
        $indexComment->base64ImgSave($image);
        return;
        try{
