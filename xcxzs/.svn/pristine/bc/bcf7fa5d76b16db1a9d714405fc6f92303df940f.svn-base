...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" lay-verify="required" placeholder="如“ 1号楼 ”" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="house_number" lay-verify="required" min="0" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
...
<script>
    ...
    layui.use(['form','laydate','upload'], function(){
        ...
        laydate.render({elem: '#kaipan_time',trigger: 'click'});
        laydate.render({elem: '#jiaofan_time',trigger: 'click'});
        var logoUpload=upload.render({
            elem: '#logoUpload' //绑定元素
            ,url: "/xiamenyyhoutai/xcxbuilding/floor_doadd" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
