<template>
  <div class="_container">
    ...
    <el-table class="tb-title" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="join_num" label="已报名" width="100" align="center"></el-table-column>

      <el-table-column prop="opt" label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="openPage({url:'/marketing/signupLog',data:{signup_id: scope.row.id, region_no:scope.row.region_no ,type:1}})">报名记录</el-button>
   ...
   <el-dialog
    ...
    >
      <el-form style="padding-right:50px;" :model="formData" ref="formData" :rules="rules">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="副标题" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.subname" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <estates-new :region_no='region_no' :show.sync='innerVisible' @innerFormData='innerFormData'></estates-new> -->
        <el-row>
          <el-col :span="12">
        ...
        <el-form-item label="报名须知" prop="desc" :label-width="formLabelWidth">
          <el-input style="width:100%" type="textarea" :autosize="{ minRows: 2}" v-model="formData.desc" placeholder="请输入内容"></el-input>
        </el-form-item>

        <el-row>
          <el-col :span="12">
            <el-form-item label="分享标题" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.share_title" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="分享描述" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.share_desc" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        </el-row>

        <el-form-item label="上传分享海报" :label-width="formLabelWidth" ref="cover" prop="cover">
  ...
  methods:{
    ...
    doEdit(e={}){
      if(Object.keys(e).length>0){
        ...
        this.default_src = this.$getRealImgUrl(this.formData.share_img)
      }
    ...
    //图片上传后操作
    onUploadedImg(e){
      // this.formData.share_img = e.res.info.url;
