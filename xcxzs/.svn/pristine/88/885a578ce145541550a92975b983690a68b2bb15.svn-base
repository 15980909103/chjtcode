  ...
  <body class="layui-anim layui-anim-up">
    ...
    <script>
      ...
      function getPageData() {
        ...
        ajax("/xiamenyyhoutai/xcxstore/manager_page",{title:title,status:status,curr:curr,limit:limit},function (data) {
          if(data.success){
            $("#tbody").empty();
            for(var i in data['data']){
              var id = data['data'][i]['mgid'];
              ...
              var $content = '<tr>' +
                      ...
                      '<td class="td-manage">'+
                      '<button type="button" class="layui-btn layui-btn layui-btn-xs" onclick="click_edit(\'人员管理\',\'/xiamenyyhoutai/xcxstore/manager_agent_index\','+said+',\'1000\')" ><i class="layui-icon">&#xe66f;</i>人员管理</button>'+
                      '<button type="button" class="layui-btn layui-btn layui-btn-xs" onclick="click_edit_said(\'编辑\',\'/xiamenyyhoutai/xcxstore/manager_edit\','+id+','+said+',\'680\',\'650\')" ><i class="layui-icon">&#xe642;</i>编辑</button>'+
