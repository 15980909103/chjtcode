    ...
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="required" autocomplete="off" maxlength="250" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" name="url" autocomplete="off" maxlength="250" class="layui-input">
            </div>
            <label class="layui-form-label">
                <span class="x-red">*</span>权重
            </label>
            <div class="layui-input-inline">
                <input type="number" min="0" name="weight" autocomplete="off" maxlength="250" class="layui-input" value="1">
            </div>
        </div>
        <hr/>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <img id="myimg" class="myimg" src="/upload/static/empty.png" alt="暂无图片" style="max-width: 100%;">
            </div>
        </div>
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        var logoUpload=upload.render({
            ...
            ,url: "/xiamenyyhoutai/xcxarticle/advertising_doadd" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
