<template>
  <el-dialog
    ...
    <el-form :inline="true" :model="innerSearch" class="form-serch">
      ...
      <el-form-item >
        <el-select style="width:150px;" v-model="innerSearch.recommend" placeholder="推荐选择">
          <el-option label="全部" value="-1"></el-option>
    ...
    >
      ...
      <el-table-column property="sale_status" width="80" label="销售状态" align="center">
      ...
      <el-table-column property="city_str" width="180" label="城市" align="center"></el-table-column>
