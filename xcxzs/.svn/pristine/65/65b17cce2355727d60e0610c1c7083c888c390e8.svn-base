        ...
        <div class="layui-form-item">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="types" id="type" lay-verify="required" lay-filter="types">
                        <option value="3" <?php if($data['type']==3){echo 'selected="selected"';}?>>项目组长</option>
                        <option value="6" <?php if($data['type']==6){echo 'selected="selected"';}?>>渠道组长</option>
                        <option value="7" <?php if($data['type']==7){echo 'selected="selected"';}?>>项目负责人</option>
                        <option value="8" <?php if($data['type']==8){echo 'selected="selected"';}?>>区域负责人</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input id="name" name="name" placeholder="" class="layui-input" value="<?php echo $data['name']?>">
                </div>
            </div>
...
<!--            </div>-->
        ...
        <div class="layui-form-item" lay-filter="my-radio"  style="display: none;"  id="groupname">
            <label class="layui-form-label">
        ...
        <div class="my-div-content layui-form" lay-filter="my-radio"  style="display: none;" id="groupinfo">
        ...
        this.$nextTick(function () {
            ...
            layui.use(['form'], function(){
                ...
                form.on('submit(btn)', function(data){
                    ...
                    if(oldType != type) {
                        if(oldType === 3) {
                            msg = '该账号绑定的工作组都将解绑，' + msg;
                        } else if(oldType === 6) {
                            msg = '该账号绑定的店铺都将解绑，' + msg;
                        } else if(oldType === 7) {
                            msg = '该账号绑定的楼盘都将解绑，' + msg;
                        }
                    }
                    ...
                    layer.confirm(msg,function(){
                        ajax("/xiamenyyhoutai/xcxstore/staff_doedit",{said:_said,mgids:mgids,type:type,name:name,province:province,city:city,area:area},function(res){
                            if(res.success){
