	...
	return window.formSelects = formSelects = {
		...
		on:function(options){//开启
			...
			layui.use(['form', 'jquery'], function(){
				...
				$(document).on('click', 'select[lay-filter="'+formSelects.options.layFilter+'"] + div input', function(){
					formSelects.show();
				});
				$(document).on('click', 'body:not(select[lay-filter="'+formSelects.options.layFilter+'"] + div)', function(e){
