    ...
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" maxlength="250" class="layui-input">
            </div>
            <label class="layui-form-label">
                <span class="x-red">*</span>排序
            </label>
            <div class="layui-input-inline">
                <input type="number" name="sort" required="" lay-verify="required" min="0" autocomplete="off" class="layui-input" value="0">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" autocomplete="off" maxlength="250" class="layui-input" value="">
            </div>
        </div>
        <hr/>
        <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        var logoUpload=upload.render({
            ...
            ,url: "/xiamenyyhoutai/xcxarticle/figure_doadd" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
