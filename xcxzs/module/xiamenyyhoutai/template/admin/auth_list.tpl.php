...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" action="/xiamenyyhoutai/admin/auth_list" method="get" id="myForm" style="width:95%">
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
					<div class="layui-input-inline">
                      <input type="text" name="controller" placeholder="控制器" autocomplete="off" class="layui-input">
                    </div>
					<div class="layui-input-inline">
                      <input type="text" name="controller_name" placeholder="控制器名称" autocomplete="off" class="layui-input">
                    </div>
					<div class="layui-input-inline">
                      <input type="text" name="action" placeholder="方法" autocomplete="off" class="layui-input">
                    </div>
					<div class="layui-input-inline">
                      <input type="text" name="action_name" placeholder="方法名称" autocomplete="off" class="layui-input">
                    </div>
...
<!--            <xblock>-->
<!--                <button class="layui-btn" onClick="add('添加权限','/xiamenyyhoutai/admin/auth_add','800','510')"><i class="layui-icon">&#xe608;</i>添加</button>-->
            ...
            <table class="layui-table">
				...
				<?php foreach($rows as $v){?>
                    <tr class="<?php echo $v['id'];?>">
                        ...
                        <!--<td class="td-manage">
                            <a title="编辑" href="javascript:;" onClick="edit('编辑','/xiamenyyhoutai/admin/auth_edit/<?php /*echo $v['id'];*/?>','4','','510')"
           ...
           function edit (title,url,id,w,h) {
            ...
            function del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    ajax("/xiamenyyhoutai/admin/auth_del/"+id,{},function(res){
                        if(res.ajax_error){
