...
<html>
    <head>
        ...
        <style>
            ...
            .layui-btn .layui-icon {font-size: 16px;vertical-align: bottom;}
            .my-img{width: 50px;height: 50px;}
            /*分页样式*/
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" action="/xiamenyyhoutai/admin/index" method="get" id="myForm" style="width:95%">
            ...
            <xblock><button class="layui-btn" onClick="add('添加管理员','/xiamenyyhoutai/admin/add','800','510')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：<?php echo $total; ?> 条</span></xblock>
                    ...
                    <tr class="<?php echo $v['id'];?>">
                        ...
                        <td>
                            <?php if(empty($v['img'])){ ?>
                                未上传
                            <?php }else{?>
                                <img class="my-img" src="<?php echo $v['img'];?>" alt="暂无图片">
                            <?php } ?>
                        </td>
                        <td>
                            <?php echo $v['name'];?>
						...
						<td>
                            <?php echo $v['gid']?$v['group_name']:"超级管理员";?>
                        </td>
                        <td>
                            <?php echo $v['city']?$v['city']:"";?>
                        </td>
                        <td >
                        ...
                        <td class="td-manage">
                            <!--<button type="button" class="layui-btn layui-btn layui-btn-xs" onClick="edit('报备权限管理','/xiamenyyhoutai/admin/reported_manage?id=<?/*= $v['id'];*/?>','','730','450')"><i class="layui-icon">&#xe620;</i>报备权限管理</button>-->
                            <a title="编辑" href="javascript:;" onClick="edit('编辑','/xiamenyyhoutai/admin/edit/<?php echo $v['id'];?>','4','','510')"
           ...
           function edit (title,url,id,w,h) {
            ...
            function del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    ajax("/xiamenyyhoutai/admin/del/"+id,{},function(res){
                        if(res.ajax_error){
