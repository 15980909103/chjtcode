    ...
    <form class="layui-form layui-form-pane" id="form_ajax">
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="name" autocomplete="off" class="layui-input" maxlength="30">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="digest" autocomplete="off" class="layui-input" maxlength="30">
            </div>
        </div>
                        ...
                        <div class="layui-input-block">
							...
							?>
								<span style="width:33.3%;">
									<input name="auths[]" type="checkbox" value="<?php echo $v['id'];?>"> <?php echo $v['action_name'];?>
								</span>
                            <?php
							$i++;
							}?>
...
<script>
    layui.use(['form','layer','upload'], function(){
        ...
        form.on('submit(btn)', function(data){
            ...
            $.ajax({
                type: 'POST',
                url: "/xiamenyyhoutai/admin/group_addsave",
                //data: data.field,
				data: postData,
                dataType: "json",
