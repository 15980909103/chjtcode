...
<div class="x-body">
    <form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input lay-filter="radio" type="radio" name="type" value="1" title="点击" checked>
                <input lay-filter="radio" type="radio" name="type" value="2" title="跳转">
                <input lay-filter="radio" type="radio" name="type" value="3" title="小程序">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="number" name="sort" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" min="1" value="1">
            </div>
        </div>
		<div class="layui-form-item">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(btn)', function(data){
            ...
            $.ajax({
                type: 'POST',
                url: "/xiamenyyhoutai/wechat/menu_addsave",
                data: data.field,
                dataType: "json",
