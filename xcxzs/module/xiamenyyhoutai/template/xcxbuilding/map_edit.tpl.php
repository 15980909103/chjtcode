...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="keyword" name="keyword" lay-verify="required">
                    <option value=""></option>
                    <option value="公交" <?=$data['keyword']=='公交'?'selected':''?>>公交</option>
                    <option value="学校" <?=$data['keyword']=='学校'?'selected':''?>>学校</option>
                    <option value="医院" <?=$data['keyword']=='医院'?'selected':''?>>医院</option>
                    <option value="购物" <?=$data['keyword']=='购物'?'selected':''?>>购物</option>
                    <option value="美食" <?=$data['keyword']=='美食'?'selected':''?>>美食</option>
                </select>
            </div>
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" lay-verify="required" autocomplete="off" class="layui-input" value="<?=$data['title']?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" name="address" lay-verify="required" autocomplete="off" class="layui-input" value="<?=$data['address']?>">
            </div>
            <label class="layui-form-label">
                <span class="x-red"></span>电话
            </label>
            <div class="layui-input-inline">
                <input type="text" name="tel" autocomplete="off" class="layui-input" value="<?=$data['tel']?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-block">
                <input type="text" name="category" autocomplete="off" class="layui-input" value="<?=$data['category']?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" name="lat" lay-verify="required" autocomplete="off" class="layui-input" value="<?=$data['lat']?>">
            </div>
            <label class="layui-form-label">
                <span class="x-red">*</span>经度
            </label>
            <div class="layui-input-inline">
                <input type="text" name="lng" lay-verify="required" autocomplete="off" class="layui-input" value="<?=$data['lng']?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="distance" lay-verify="required" autocomplete="off" class="layui-input" value="<?=$data['distance']?>">
            </div>
        </div>
...
<script>
    ...
    layui.use(['form'], function(){
        ...
        form.on('submit(btn)', function(data){
            ...
            ajax("/xiamenyyhoutai/xcxbuilding/map_doedit",$.extend({},data.field,{province:province,city:city,area:area}),function(res){
                if(res.success){
