...
<div id="my_body" class="x-body">
        ...
        <div class="layui-form-pane" style="margin-top: 15px;">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="keyword2" lay-verify="required">
                        <option value=""></option>
    ...
    <xblock>
        <button class="layui-btn" onclick="click_edit('添加','/xiamenyyhoutai/xcxbuilding/map_add',<?=$data['id']?>,'680','450');"><i class="layui-icon">&#xe608;</i>添加</button>
    </xblock>
...
<script>
    ...
    function getPageData() {
        ...
        ajax("/xiamenyyhoutai/xcxbuilding/map_page",{id:<?=$data['id']?>,keyword:keyword,curr:curr,limit:limit},function (data) {
            if(data.success){
                $("#tbody").empty();
                for(var i in data['data']){
                    ...
                    var $content = '<tr>' +
                        ...
                        '<td class="td-manage">'+
                        '<button type="button" class="layui-btn layui-btn layui-btn-xs" onclick="click_edit(\'编辑\',\'/xiamenyyhoutai/xcxbuilding/map_edit\','+id+',\'680\',\'450\')" ><i class="layui-icon">&#xe642;</i>编辑</button>'+
    ...
    function click_del(id){
        layer.confirm('确认要删除吗？',function(){
            ajax("/xiamenyyhoutai/xcxbuilding/map_del",{id:id},function(res){
                if(res.success){
