...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" lay-verify="required" placeholder="如“ 3室2厅2卫 ”" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="construction_area" lay-verify="required" min="0" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" name="price_total" lay-verify="required" placeholder="如“ 500万/套 ”" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">
                <span class="x-red">*</span>排序
            </label>
            <div class="layui-input-inline">
                <input type="number" name="sort" lay-verify="required" min="0" value="0" autocomplete="off" class="layui-input">
            </div>
        </div>
        <hr>
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        var logoUpload=upload.render({
            ...
            ,url: "/xiamenyyhoutai/xcxbuilding/door_doadd" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
