            ...
            layui.use(['form'], function(){
                ...
                form.on('submit(btn)', function(data){
                    ...
                    layer.confirm('确认要修改吗？',function(){
                        ajax("/xiamenyyhoutai/xcxstore/manager_doedit",{id:_id,said:_said,building_ids:building_ids,title:title,province:province,city:city,area:area},function(res){
                            if(res.success){
