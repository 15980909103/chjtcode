...
<body style="background-color: #393D49">
	<div class="x-box">
		...
		<div class="x-mid">
			...
			<div class="input">
				<form method="post" action="/xiamenyyhoutai/login/go" class="layui-form">
					...
					<div class="layui-form-item x-login-box">
						...
						<div class="layui-input-inline">
							<input type="password" id="password" name="password" required="" lay-verify="required" autocomplete="off" placeholder="******" class="layui-input">
						</div>
					</div>
	...
	<p style="color:#fff;text-align: center;">Copyright © 2018.Company name All rights X-admin </p>
