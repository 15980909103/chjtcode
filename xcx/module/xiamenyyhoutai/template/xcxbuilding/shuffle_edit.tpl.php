...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="sort" min="0" value="<?=$data['sort']?>" autocomplete="off" class="layui-input">
            </div>
        </div>
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        var logoUpload=upload.render({
            ...
            ,url: "/xiamenyyhoutai/xcxbuilding/shuffle_doedit" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
        ...
        form.on('submit(btn)', function(data){
            ...
            if(fileIndex==""){
                ...
                ajax("/xiamenyyhoutai/xcxbuilding/shuffle_doedit",{parame:JSON.stringify(parameter)},function(res){
                    if(res.success){
                        parent.layer.alert("保存成功", {icon: 6},function (index2) {
                            parent.getPageData(parent.$('#my_body').data('curr'));
                            parent.layer.close(index2);
