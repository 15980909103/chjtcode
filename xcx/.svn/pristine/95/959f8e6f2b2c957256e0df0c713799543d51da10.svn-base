<template>
  <el-form style="padding-right:50px;" :model="formData" ref="formData" :rules="rules">
    ...
    <div class="mapeditor-title">活动内容</div>
    <el-row >
      <el-col :lg="24" :sm="24" :xs="24">
        <el-form-item  prop="context_rule" label="内容详情" label-width="80px">
          <Tinymce ref="editor" :height="400"   v-model="formData.activity_img" />
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row >
      <el-col :lg="10" :sm="12" :xs="24">
        <el-form-item prop="recommend" label="是否推荐" label-width="110px">
          <el-radio v-model="formData.recommend" label="1">是</el-radio>
          <el-radio v-model="formData.recommend" label="0">否</el-radio>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row >
      <el-col :lg="10" :sm="12" :xs="24">
        <el-form-item prop="is_cheap" label="是否低价盘" label-width="110px">
          <el-radio v-model="formData.is_cheap" label="1">是</el-radio>
          <el-radio v-model="formData.is_cheap" label="0">否</el-radio>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <!-- <el-row v-if="subways&&subways.length">
      <el-col :lg="24" :sm="24" :xs="24">
        <el-form-item prop="subways" label="附近地铁" label-width="110px">
          <el-checkbox-group v-model="formData.subways">
    ...
    <!-- <el-row >
      <el-col :lg="24" :sm="24" :xs="24">
        <el-form-item prop="feature_tag" label="基本属性" label-width="110px">
          <el-checkbox-group v-model="formData.base_tag">
            <el-checkbox v-for="item in base_tag" :key="item.id" :label="String(item.id)">{{item.name}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row >
      <el-col :lg="24" :sm="24" :xs="24">
        <el-form-item prop="selling_point_tag" label="卖点标签" label-width="110px">
          <el-checkbox-group v-model="formData.selling_point_tag">
            <el-checkbox v-for="item in selling_point_tag" :key="item.id" :label="String(item.id)">{{item.name}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-col>
    </el-row> -->
    ...
    <el-row >
      <!-- <el-col :lg="11" :sm="12" :xs="24">
        <el-form-item prop="bind_building" label="绑定楼栋" label-width="110px">
          <el-input placeholder="请输入楼栋" v-model="formData.bind_building"></el-input>
        </el-form-item>
      </el-col> -->
    ...
    <div class="mapeditor-title">销售许可证</div>

    <el-row :lg="18" :md="18" :xs="24">
      <el-button type="primary" @click="onAdd('license')">添加</el-button>
    </el-row>
    <el-row  v-for="(item,i) in licenseItems"  :key="'license'+i">
      <el-col :lg="7" :md="18" :xs="24">
      ...
      <el-col :lg="7" :md="18" :xs="24" style="display:none">
        <el-form-item prop="sales_license" label="登记楼栋" label-width="120px">
    ...
    <div class="mapeditor-title">优惠信息</div>

    <el-row :lg="24" :md="24" :xs="24">
    ...
    <div v-if="release_status!=2" class="mapeditor-title">活动-信息展示</div>

    <el-row v-if="release_status!=2" >
      <el-col :lg="10" :sm="12" :xs="24">
        <el-form-item prop="activity_type" label="信息展示" label-width="110px">
          <el-radio v-model="formData.activity_type" label="1">展示</el-radio>
          <el-radio v-model="formData.activity_type" label="2">隐藏</el-radio>
        </el-form-item>
      </el-col>
    </el-row>
        ...
        that.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(that.formData.subway_sites) {
              var arr_subway = [];
              // for (var fiss of that.formData.subway_sites) {// 选择的站点
              //   for(var tiss of that.subway_sites) {// 所有站点
              //     if(tiss.id == fiss) {// 获取所选站点附属地铁线信息
