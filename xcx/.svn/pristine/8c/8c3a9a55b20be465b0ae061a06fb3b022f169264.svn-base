...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="tbl_name" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="orders" min="0" value="0" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(btn)', function(data){
            ajax("/xiamenyyhoutai/xcxbuilding/dict_doadd",data.field,function(res){
                if(res.success){
