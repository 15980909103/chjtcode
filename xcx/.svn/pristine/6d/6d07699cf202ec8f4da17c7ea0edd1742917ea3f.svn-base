...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="is_hot" lay-text="推荐|普通" lay-filter="hot" lay-skin="switch">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        var logoUpload=upload.render({
            ...
            ,url: "/xiamenyyhoutai/xcxarticle/article_doadd" //上传接口
            ,size: 2048
            ,accept: "images"
            ,auto:false
            ,data:{
                ...
                is_hot: function(){
                    return  document.getElementsByName("is_hot")[0].checked?1:0;
                },
