...
<div class="x-body">
    <form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="primordial_id" autocomplete="off" class="layui-input" value="<?php echo $data['primordial_id'];?>">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="token" autocomplete="off" class="layui-input" value="<?php echo $data['token'];?>">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="appid" autocomplete="off" class="layui-input" value="<?php echo $data['appid'];?>">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="appsecret" autocomplete="off" class="layui-input" value="<?php echo $data['appsecret'];?>">
            </div>
        </div>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(btn)', function(data){
            ...
            $.ajax({
                type: 'POST',
                url: "/xiamenyyhoutai/wechat/public_editsave",
                data: data.field,
                dataType: "json",
