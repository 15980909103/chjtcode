    ...
    <form class="layui-form layui-form-pane" action="javascript:void(0);">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" name="title" required="" lay-verify="required" autocomplete="off" maxlength="250" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <select name="types" id="type" lay-verify="required">
                    <option value="0">项目组</option>
                    <option value="1">渠道组</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            layui.use(['form'], function(){
                ...
                form.on('submit(btn)', function(data){
                    ...
                    layer.confirm('确认要添加吗？',function(){
                        ajax("/xiamenyyhoutai/xcxstore/manager_doadd",{building_ids:building_ids,title:title,province:province,city:city,area:area,type:type},function(res){
                            if(res.success){
