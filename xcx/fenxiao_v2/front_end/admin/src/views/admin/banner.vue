  ...
  <div class="_container">
    <div class="tb-top" style="float:right;margin-bottom: 30px;">
      <el-form :inline="true" :model="searchData" class="form-serch" >
        ...
        <el-form-item  v-if="selectLab" label="标签:">
          <el-select v-model="searchData.place_id" placeholder="请选择">
            <el-option  v-for="item in placeList" :key="item.id" :label="item.desc" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
    ...
    <el-table class="tb-title" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="title" label="广告标题" width="200" align="center"></el-table-column>
      ...
      <el-table-column prop="read_num_upper" label="浏览次数" width="100" align="center"></el-table-column>
   ...
   <el-dialog
    ...
    >
      <el-form style="padding-right:50px;" :model="formData" ref="formData" :rules="rules">
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="广告副标题"  :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.sub_title" r placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="类型" :label-width="formLabelWidth">
         ...
         <el-row>
          ...
          <el-col :span="12"  v-if="formData.type == 3">
            <el-form-item label="请选择资讯" prop="forid" :label-width="formLabelWidth">
              <el-row>
                <el-col :span="18">
                          <span @click="changeInnerShow">
                            <el-input style="width:100%;display:none;"  v-model="formData.article_id" placeholder="请选择资讯"></el-input>
                            <el-input style="width:100%" :disabled='true'  v-model="formData.article_name" placeholder="请选择资讯"></el-input>
                          </span>
                </el-col>
                <el-col :span="4" style="text-align: right;">
                  <el-button  @click="clearInner">清空</el-button>
            ...
            <actives-new :region_no='formData.region_no' :show.sync='innerVisible' @innerFormData='innerFormData1'></actives-new>
          </el-col>

        </el-row>

        <el-form-item v-if="formData.type !='1'" class="city-box" label="排版样式"  :label-width="formLabelWidth" >
        ...
        <el-form-item v-if="formData.type !='1'" label="上传图片" :label-width="formLabelWidth" ref="cover" prop="cover">
          <img-upload2
            ref="imgUpload"
            url="upload/imgUpload"
            :show-file-list="true"
            :thumb='{ isthumb:0, width:1200}'
            :limit="imglimit"
        ...
        <el-form-item label="投放量" :label-width="formLabelWidth">
           <el-radio-group v-model="formData.put_type">
             <el-radio  label="1">投放时间</el-radio>
             <el-radio  label="2">点击量</el-radio>
             <el-radio  label="3">浏览量</el-radio>
           </el-radio-group>
        </el-form-item>

        <el-row v-if="formData.put_type == 1">
          <el-col :span="12">
        ...
        <el-row v-if="formData.put_type == 2">
           <el-form-item label="点击量" prop="click_on_upper" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.click_on_upper" placeholder="请输入内容"></el-input>
            </el-form-item>
        </el-row>

          <el-row v-if="formData.put_type == 3">
           <el-form-item label="浏览量" prop="read_num_upper" :label-width="formLabelWidth">
              <el-input style="width:100%" v-model="formData.read_num_upper" placeholder="请输入内容"></el-input>
            </el-form-item>
        </el-row>
...
import ActiveNew from '@/components/InnerTable/ActiveNew.vue';
...
export default {
  ...
  methods:{
    ...
    innerFormData1(e){
      this.formData.article_id = e.id
      this.formData.article_name = e.name
    },
    clearInner(){
    ...
    console.log(88888,searchdata)
      var that = this
      util.requests("post",{
        url:"banner/getBannerList",
        data: searchdata
      }).then(res=>{
        console.log(77,res.data.list)
